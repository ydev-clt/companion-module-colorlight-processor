...
export const ACTION_SUPPORT: Record<ACTION_ID, SupportRule> = {
  ...
  [ACTION_ID.PIC_ADJ_SET]: { protocols: AB, except: ['U'] },
  [ACTION_ID.PIC_ADJ_GET]: { protocols: AB, except: ['U'] },
  [ACTION_ID.HUE_SET]: { protocols: AB, except: ['U'] },
  [ACTION_ID.HUE_GET]: { protocols: AB, except: ['U'] },
  [ACTION_ID.SATURATION_SET]: { protocols: AB, except: ['U'] },
  [ACTION_ID.SATURATION_GET]: { protocols: AB, except: ['U'] },
  [ACTION_ID.CONTRAST_SET]: { protocols: AB, except: ['U'] },
  [ACTION_ID.CONTRAST_GET]: { protocols: AB, except: ['U'] },
  [ACTION_ID.BRTCOMP_SET]: { protocols: AB, except: ['U'] },
  ...
  // [ACTION_ID.PR_VIDEO_COUNT_GET]: { protocols: AB, except: ['U'] },
