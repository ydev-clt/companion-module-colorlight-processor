...
export const ACTION_SUPPORT: Record<ACTION_ID, SupportRule> = {
  ...
  [ACTION_ID.SNDINFO_GET]: AB,
  [ACTION_ID.SND_ETH_GET]: AB,
  [ACTION_ID.PR_LAYER_GET]: AB,
  [ACTION_ID.PR_GROUP_GET]: AB,
  [ACTION_ID.PR_VIDEO_GET]: AB,
  [ACTION_ID.PR_VSYNC_GET]: AB,
  [ACTION_ID.PORT_AREA_GET]: AB,
  [ACTION_ID.PR_VIDEO_COUNT_GET]: AB_EXCEPT_U,

  // === Multi-function card (pr_rcv_state unsupported on U-series) ===
  [ACTION_ID.MFC_PROBE_GET]: AB,
  [ACTION_ID.RCV_PROBE_GET]: AB,
  [ACTION_ID.MOD_PROBE_GET]: AB,
